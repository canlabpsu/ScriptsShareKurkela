...
%CHANGE...needs to be changed for each new study - these values are placesholders
matlabbatch{2}.spm.temporal.st.nslices  = 34;
matlabbatch{2}.spm.temporal.st.tr       = 2;
matlabbatch{2}.spm.temporal.st.ta       = 2-(2/34);
matlabbatch{2}.spm.temporal.st.so       = [1:2:34 2:2:34];
...
anat_directory = fullfile(directories.anat, subjectid, 'run2'); % path to this subjects anatomical folder  %NAD changed for FAME to include run2
...
matlabbatch{6}.spm.spatial.smooth.prefix  = 's12';
